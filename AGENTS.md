...
**Entities** (14): `AcademicTerm`, `AcademicYear`, `Administrator`, `Applicant`, `Application`, `Course`, `Fee`, `Institution`, `Intake`, `Invoice`, `Journal`, `Login`, `Scoresheet`, `TableView`.
