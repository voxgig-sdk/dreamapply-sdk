...
|---|---|---|
| `ts/` | @voxgig-sdk/dreamapply | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dreamapply \
      --repository voxgig-sdk/dreamapply-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dreamapply` shows it, and
`npm trust revoke @voxgig-sdk/dreamapply --id=<id>` removes it.
