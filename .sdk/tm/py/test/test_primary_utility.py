# Dreamapply SDK primary utility test
...
from projectname_sdk import DreamapplySDK
from projectname_sdk.core.spec import DreamapplySpec
from projectname_sdk.core.result import DreamapplyResult
from projectname_sdk.core.response import DreamapplyResponse
from projectname_sdk.core.operation import DreamapplyOperation
from projectname_sdk.core.error import DreamapplyError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import DreamapplyBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return DreamapplyError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = DreamapplySDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = DreamapplySDK.test(None, None)
        ...
        class TestInitFeature(DreamapplyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DreamapplyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DreamapplySpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DreamapplySDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DreamapplySDK.test(None, setup_opts)
