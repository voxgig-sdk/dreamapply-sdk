...
class DreamapplyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DreamapplyTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DreamapplyTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DreamapplyTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
