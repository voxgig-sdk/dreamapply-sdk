...
class DreamapplyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DreamapplyTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DreamapplyTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DreamapplyTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
