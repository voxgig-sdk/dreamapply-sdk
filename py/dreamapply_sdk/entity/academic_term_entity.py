# Dreamapply SDK AcademicTerm entity
...
from dreamapply_sdk.dreamapply_types import (
    AcademicTerm,
    AcademicTermLoadMatch,
    AcademicTermListMatch,
)
...
class AcademicTermEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AcademicTermEntity(self._client, opts)
    ...
    def data_get(self) -> AcademicTerm:
    ...
    def match_get(self) -> AcademicTerm:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AcademicTerm:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AcademicTerm().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AcademicTerm]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AcademicTerm().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
