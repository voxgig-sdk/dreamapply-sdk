# Dreamapply SDK Administrator entity

from __future__ import annotations

from dreamapply_sdk.utility.voxgig_struct import voxgig_struct as vs
from dreamapply_sdk.core import helpers
from dreamapply_sdk.dreamapply_types import (
    Administrator,
    AdministratorLoadMatch,
    AdministratorListMatch,
)
...
class AdministratorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdministratorEntity(self._client, opts)
    ...
    def data_get(self) -> Administrator:
    ...
    def match_get(self) -> Administrator:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Administrator:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Administrator().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Administrator]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Administrator().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
