# Dreamapply SDK AcademicYear entity
...
from dreamapply_sdk.dreamapply_types import (
    AcademicYear,
    AcademicYearLoadMatch,
    AcademicYearListMatch,
)
...
class AcademicYearEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AcademicYearEntity(self._client, opts)
    ...
    def data_get(self) -> AcademicYear:
    ...
    def match_get(self) -> AcademicYear:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AcademicYear:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AcademicYear().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AcademicYear]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AcademicYear().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
