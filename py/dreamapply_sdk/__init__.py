...
from dreamapply_sdk.features import _has_feature, _make_feature
...
class DreamapplySDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "DreamapplySDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DreamapplySDK: graphql: " + str(msg))
            res["graphql"] = errors
