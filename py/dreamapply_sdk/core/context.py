# Dreamapply SDK context

from __future__ import annotations
import random

from dreamapply_sdk.utility.voxgig_struct import voxgig_struct as vs
from dreamapply_sdk.core.control import DreamapplyControl
...
from dreamapply_sdk.core.helpers import get_ctx_prop, to_map


class DreamapplyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, DreamapplySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DreamapplyResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DreamapplyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DreamapplyError(code, msg, self)
