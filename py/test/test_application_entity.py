    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set DREAMAPPLY_TEST_APPLICATION_ENTID JSON to run live")
        client = setup["client"]
        ...
        application_ref01_data_dt0_load_result = helpers.to_map(application_ref01_data_dt0_loaded)
...
def _application_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("DREAMAPPLY_TEST_APPLICATION_ENTID"))
