# Dreamapply SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DreamapplySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DreamapplySDK(...) and DreamapplySDK.test(...) become
#      DreamapplySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dreamapply_sdk"
_SDK_CLASS = "DreamapplySDK"
