...
class InvoiceEntity extends DreamapplyEntityBase<Invoice> {
  ...
  make(this: InvoiceEntity) {
    return new InvoiceEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: InvoiceLoadMatch, ctrl?: Control): Promise<InvoiceEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Invoice> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: InvoiceListMatch, ctrl?: Control): Promise<InvoiceEntity[]> {
  ...
  async remove(
    this: any, reqmatch?: InvoiceRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<InvoiceEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
