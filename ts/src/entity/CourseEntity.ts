...
class CourseEntity extends DreamapplyEntityBase<Course> {
  ...
  make(this: CourseEntity) {
    return new CourseEntity(this._client, this.entopts())
  }
  ...
  async load(this: any, reqmatch?: CourseLoadMatch, ctrl?: Control): Promise<CourseEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Course> return stays clean under strict null checks.
