...
class DreamapplySDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('DreamapplySDK: graphql: ' +
  ...
  AcademicTerm(entopts?: Record<string, any>) {
    const self = this
    return new AcademicTermEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  AcademicYear(entopts?: Record<string, any>) {
    const self = this
    return new AcademicYearEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Administrator(entopts?: Record<string, any>) {
    const self = this
    return new AdministratorEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Applicant(entopts?: Record<string, any>) {
    const self = this
    return new ApplicantEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Fee(entopts?: Record<string, any>) {
    const self = this
    return new FeeEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Institution(entopts?: Record<string, any>) {
    const self = this
    return new InstitutionEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Intake(entopts?: Record<string, any>) {
    const self = this
    return new IntakeEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Journal(entopts?: Record<string, any>) {
    const self = this
    return new JournalEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Scoresheet(entopts?: Record<string, any>) {
    const self = this
    return new ScoresheetEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TableView(entopts?: Record<string, any>) {
    const self = this
    return new TableViewEntity(self, entopts)
  }
