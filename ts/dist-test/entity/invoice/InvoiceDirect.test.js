...
(0, node_test_1.describe)('InvoiceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-invoice', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-invoice', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-invoice', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-invoice', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DREAMAPPLY_TEST_INVOICE_ENTID'];
...
//# sourceMappingURL=InvoiceDirect.test.js.map