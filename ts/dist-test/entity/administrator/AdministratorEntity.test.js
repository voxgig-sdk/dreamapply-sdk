...
(0, node_test_1.describe)('AdministratorEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'administrator.' + op, live))
                return;
        }
        ...
        let administrator_ref01_data = Object.values(setup.data.existing.administrator)[0];
        // LIST
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/administrator/AdministratorTestData.json');
    ...
    let idmap = transform(['administrator01', 'administrator02', 'administrator03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['DREAMAPPLY_TEST_ADMINISTRATOR_ENTID'];
...
//# sourceMappingURL=AdministratorEntity.test.js.map