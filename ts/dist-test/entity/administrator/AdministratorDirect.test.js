...
(0, node_test_1.describe)('AdministratorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DreamapplySDK({
    ...
    (0, node_test_1.test)('direct-load-administrator', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-administrator', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-administrator', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-administrator', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.DREAMAPPLY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DreamapplySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.DREAMAPPLY_APIKEY,
            server: {
                instance: env.DREAMAPPLY_SERVER_INSTANCE,
            },
        }));
        let idmap = env['DREAMAPPLY_TEST_ADMINISTRATOR_ENTID'];
    ...
    const client = new __1.DreamapplySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AdministratorDirect.test.js.map