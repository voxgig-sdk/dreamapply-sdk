...
(0, node_test_1.describe)('TableViewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-table_view', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-table_view', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-table_view', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-table_view', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DREAMAPPLY_TEST_TABLE_VIEW_ENTID'];
...
//# sourceMappingURL=TableViewDirect.test.js.map