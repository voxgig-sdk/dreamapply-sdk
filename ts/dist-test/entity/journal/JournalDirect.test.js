...
(0, node_test_1.describe)('JournalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-journal', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-journal', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DREAMAPPLY_TEST_JOURNAL_ENTID'];
...
//# sourceMappingURL=JournalDirect.test.js.map