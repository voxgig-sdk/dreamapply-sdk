...
(0, node_test_1.describe)('FeeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-fee', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-fee', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-fee', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-fee', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DREAMAPPLY_TEST_FEE_ENTID'];
...
//# sourceMappingURL=FeeDirect.test.js.map