...
(0, node_test_1.describe)('AcademicTermEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'academic_term.' + op, live))
                return;
        }
        ...
        let academic_term_ref01_data = Object.values(setup.data.existing.academic_term)[0];
        // LIST
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/academic_term/AcademicTermTestData.json');
    ...
    let idmap = transform(['academic_term01', 'academic_term02', 'academic_term03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['DREAMAPPLY_TEST_ACADEMIC_TERM_ENTID'];
...
//# sourceMappingURL=AcademicTermEntity.test.js.map