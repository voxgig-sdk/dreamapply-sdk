...
(0, node_test_1.describe)('InstitutionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'institution.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/institution/InstitutionTestData.json');
    ...
    let idmap = transform(['institution01', 'institution02', 'institution03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['DREAMAPPLY_TEST_INSTITUTION_ENTID'];
...
//# sourceMappingURL=InstitutionEntity.test.js.map