...
(0, node_test_1.describe)('AcademicYearDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-academic_year', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-academic_year', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-academic_year', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-academic_year', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DREAMAPPLY_TEST_ACADEMIC_YEAR_ENTID'];
...
//# sourceMappingURL=AcademicYearDirect.test.js.map