...
(0, node_test_1.describe)('AcademicYearEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'academic_year.' + op, live))
                return;
        }
        ...
        let academic_year_ref01_data = Object.values(setup.data.existing.academic_year)[0];
        // LIST
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/academic_year/AcademicYearTestData.json');
    ...
    let idmap = transform(['academic_year01', 'academic_year02', 'academic_year03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AcademicYearEntity.test.js.map