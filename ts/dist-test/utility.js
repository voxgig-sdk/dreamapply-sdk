...
function envOverride(m) {
    if ('TRUE' === process.env.DREAMAPPLY_TEST_LIVE ||
        'TRUE' === process.env.DREAMAPPLY_TEST_OVERRIDE) {
    ...
    m.DREAMAPPLY_TEST_EXPLAIN = process.env.DREAMAPPLY_TEST_EXPLAIN || m.DREAMAPPLY_TEST_EXPLAIN;
    return m;
}
