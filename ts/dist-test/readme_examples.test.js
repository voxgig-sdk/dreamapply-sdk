...
const TEST_SEED = { "entity": { "academic_term": { "test01": { "id": "test01" } }, "academic_year": { "test01": { "id": "test01" } }, "administrator": { "test01": { "id": "test01" } }, "applicant": { "test01": { "id": "test01" } }, "application": { "test01": { "id": "test01" } }, "course": { "test01": { "id": "test01" } }, "fee": { "test01": { "id": "test01" } }, "institution": { "test01": { "id": "test01" } }, "intake": { "test01": { "id": "test01" } }, "invoice": { "test01": { "id": "test01" } }, "journal": { "test01": { "id": "test01" } }, "login": { "test01": { "id": "test01" } }, "scoresheet": { "test01": { "id": "test01" } }, "table_view": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+DreamapplySDK\b/.test(code) ||
        /\bDreamapplySDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+DreamapplySDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/DreamapplySDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
