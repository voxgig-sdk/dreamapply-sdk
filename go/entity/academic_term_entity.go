...
type AcademicTermEntity struct {
	name    string
...
func NewAcademicTermEntity(client *core.DreamapplySDK, entopts map[string]any) *AcademicTermEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AcademicTermEntity) GetName() string { return e.name }
...
func (e *AcademicTermEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AcademicTermEntity) Deleted() bool {
	return e.deleted
}


func (e *AcademicTermEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAcademicTermEntity(e.client, opts)
}

func (e *AcademicTermEntity) Data(args ...any) any {
...
func (e *AcademicTermEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AcademicTerm; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AcademicTermEntity) DataTyped(data ...AcademicTerm) AcademicTerm {
	if len(data) > 0 {
		return typedFrom[AcademicTerm](e.Data(asMap(data[0])))
	}
	return typedFrom[AcademicTerm](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AcademicTerm (all fields
// optional at the wire level).
func (e *AcademicTermEntity) MatchTyped(match ...AcademicTerm) AcademicTerm {
	if len(match) > 0 {
		return typedFrom[AcademicTerm](e.Match(asMap(match[0])))
	}
	return typedFrom[AcademicTerm](e.Match())
}
...
func (e *AcademicTermEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AcademicTermEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AcademicTermLoadMatch and returns an AcademicTerm. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AcademicTermEntity) LoadTyped(reqmatch AcademicTermLoadMatch, ctrl map[string]any) (AcademicTerm, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AcademicTerm{}, err
	}
	return typedFrom[AcademicTerm](res), nil
}




func (e *AcademicTermEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AcademicTermListMatch and returns []AcademicTerm. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AcademicTermEntity) ListTyped(reqmatch AcademicTermListMatch, ctrl map[string]any) ([]AcademicTerm, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AcademicTerm](res), nil
}



func (e *AcademicTermEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AcademicTermEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AcademicTermEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AcademicTermEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
