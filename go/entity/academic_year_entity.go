...
type AcademicYearEntity struct {
	name    string
...
func NewAcademicYearEntity(client *core.DreamapplySDK, entopts map[string]any) *AcademicYearEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AcademicYearEntity) GetName() string { return e.name }
...
func (e *AcademicYearEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AcademicYearEntity) Deleted() bool {
	return e.deleted
}


func (e *AcademicYearEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAcademicYearEntity(e.client, opts)
}

func (e *AcademicYearEntity) Data(args ...any) any {
...
func (e *AcademicYearEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AcademicYear; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AcademicYearEntity) DataTyped(data ...AcademicYear) AcademicYear {
	if len(data) > 0 {
		return typedFrom[AcademicYear](e.Data(asMap(data[0])))
	}
	return typedFrom[AcademicYear](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AcademicYear (all fields
// optional at the wire level).
func (e *AcademicYearEntity) MatchTyped(match ...AcademicYear) AcademicYear {
	if len(match) > 0 {
		return typedFrom[AcademicYear](e.Match(asMap(match[0])))
	}
	return typedFrom[AcademicYear](e.Match())
}
...
func (e *AcademicYearEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AcademicYearEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AcademicYearLoadMatch and returns an AcademicYear. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AcademicYearEntity) LoadTyped(reqmatch AcademicYearLoadMatch, ctrl map[string]any) (AcademicYear, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AcademicYear{}, err
	}
	return typedFrom[AcademicYear](res), nil
}




func (e *AcademicYearEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AcademicYearListMatch and returns []AcademicYear. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AcademicYearEntity) ListTyped(reqmatch AcademicYearListMatch, ctrl map[string]any) ([]AcademicYear, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AcademicYear](res), nil
}



func (e *AcademicYearEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AcademicYearEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AcademicYearEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AcademicYearEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
