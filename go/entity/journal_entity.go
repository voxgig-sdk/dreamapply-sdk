...
func NewJournalEntity(client *core.DreamapplySDK, entopts map[string]any) *JournalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *JournalEntity) GetName() string { return e.name }
...
func (e *JournalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *JournalEntity) Deleted() bool {
	return e.deleted
}


func (e *JournalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewJournalEntity(e.client, opts)
}

func (e *JournalEntity) Data(args ...any) any {
...
func (e *JournalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Journal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *JournalEntity) DataTyped(data ...Journal) Journal {
	if len(data) > 0 {
		return typedFrom[Journal](e.Data(asMap(data[0])))
	}
	return typedFrom[Journal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Journal (all fields
// optional at the wire level).
func (e *JournalEntity) MatchTyped(match ...Journal) Journal {
	if len(match) > 0 {
		return typedFrom[Journal](e.Match(asMap(match[0])))
	}
	return typedFrom[Journal](e.Match())
}
...
func (e *JournalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *JournalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *JournalEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// JournalListMatch and returns []Journal. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *JournalEntity) ListTyped(reqmatch JournalListMatch, ctrl map[string]any) ([]Journal, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Journal](res), nil
}



func (e *JournalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *JournalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *JournalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *JournalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
