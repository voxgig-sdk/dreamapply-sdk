...
func NewApplicationEntity(client *core.DreamapplySDK, entopts map[string]any) *ApplicationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ApplicationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ApplicationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ApplicationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
