...
func NewInvoiceEntity(client *core.DreamapplySDK, entopts map[string]any) *InvoiceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InvoiceEntity) GetName() string { return e.name }
...
func (e *InvoiceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InvoiceEntity) Deleted() bool {
	return e.deleted
}


func (e *InvoiceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInvoiceEntity(e.client, opts)
}

func (e *InvoiceEntity) Data(args ...any) any {
...
func (e *InvoiceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Invoice; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InvoiceEntity) DataTyped(data ...Invoice) Invoice {
	if len(data) > 0 {
		return typedFrom[Invoice](e.Data(asMap(data[0])))
	}
	return typedFrom[Invoice](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Invoice (all fields
// optional at the wire level).
func (e *InvoiceEntity) MatchTyped(match ...Invoice) Invoice {
	if len(match) > 0 {
		return typedFrom[Invoice](e.Match(asMap(match[0])))
	}
	return typedFrom[Invoice](e.Match())
}
...
func (e *InvoiceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InvoiceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InvoiceLoadMatch and returns an Invoice. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InvoiceEntity) LoadTyped(reqmatch InvoiceLoadMatch, ctrl map[string]any) (Invoice, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Invoice{}, err
	}
	return typedFrom[Invoice](res), nil
}




func (e *InvoiceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// InvoiceListMatch and returns []Invoice. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *InvoiceEntity) ListTyped(reqmatch InvoiceListMatch, ctrl map[string]any) ([]Invoice, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Invoice](res), nil
}



func (e *InvoiceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InvoiceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *InvoiceEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// InvoiceRemoveMatch and returns an Invoice. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *InvoiceEntity) RemoveTyped(reqmatch InvoiceRemoveMatch, ctrl map[string]any) (Invoice, error) {
...
func (e *InvoiceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
