...
func NewAdministratorEntity(client *core.DreamapplySDK, entopts map[string]any) *AdministratorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdministratorEntity) GetName() string { return e.name }
...
func (e *AdministratorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdministratorEntity) Deleted() bool {
	return e.deleted
}


func (e *AdministratorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdministratorEntity(e.client, opts)
}

func (e *AdministratorEntity) Data(args ...any) any {
...
func (e *AdministratorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Administrator; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdministratorEntity) DataTyped(data ...Administrator) Administrator {
	if len(data) > 0 {
		return typedFrom[Administrator](e.Data(asMap(data[0])))
	}
	return typedFrom[Administrator](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Administrator (all fields
// optional at the wire level).
func (e *AdministratorEntity) MatchTyped(match ...Administrator) Administrator {
	if len(match) > 0 {
		return typedFrom[Administrator](e.Match(asMap(match[0])))
	}
	return typedFrom[Administrator](e.Match())
}
...
func (e *AdministratorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdministratorEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdministratorLoadMatch and returns an Administrator. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdministratorEntity) LoadTyped(reqmatch AdministratorLoadMatch, ctrl map[string]any) (Administrator, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Administrator{}, err
	}
	return typedFrom[Administrator](res), nil
}




func (e *AdministratorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AdministratorListMatch and returns []Administrator. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AdministratorEntity) ListTyped(reqmatch AdministratorListMatch, ctrl map[string]any) ([]Administrator, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Administrator](res), nil
}



func (e *AdministratorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdministratorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdministratorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdministratorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
