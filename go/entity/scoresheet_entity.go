...
func NewScoresheetEntity(client *core.DreamapplySDK, entopts map[string]any) *ScoresheetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScoresheetEntity) GetName() string { return e.name }
...
func (e *ScoresheetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ScoresheetEntity) Deleted() bool {
	return e.deleted
}


func (e *ScoresheetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewScoresheetEntity(e.client, opts)
}

func (e *ScoresheetEntity) Data(args ...any) any {
...
func (e *ScoresheetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Scoresheet; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ScoresheetEntity) DataTyped(data ...Scoresheet) Scoresheet {
	if len(data) > 0 {
		return typedFrom[Scoresheet](e.Data(asMap(data[0])))
	}
	return typedFrom[Scoresheet](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Scoresheet (all fields
// optional at the wire level).
func (e *ScoresheetEntity) MatchTyped(match ...Scoresheet) Scoresheet {
	if len(match) > 0 {
		return typedFrom[Scoresheet](e.Match(asMap(match[0])))
	}
	return typedFrom[Scoresheet](e.Match())
}
...
func (e *ScoresheetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ScoresheetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ScoresheetLoadMatch and returns an Scoresheet. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ScoresheetEntity) LoadTyped(reqmatch ScoresheetLoadMatch, ctrl map[string]any) (Scoresheet, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Scoresheet{}, err
	}
	return typedFrom[Scoresheet](res), nil
}




func (e *ScoresheetEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ScoresheetListMatch and returns []Scoresheet. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ScoresheetEntity) ListTyped(reqmatch ScoresheetListMatch, ctrl map[string]any) ([]Scoresheet, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Scoresheet](res), nil
}



func (e *ScoresheetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ScoresheetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ScoresheetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ScoresheetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
