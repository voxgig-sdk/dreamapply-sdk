...
func NewCourseEntity(client *core.DreamapplySDK, entopts map[string]any) *CourseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CourseEntity) GetName() string { return e.name }
...
func (e *CourseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CourseEntity) Deleted() bool {
	return e.deleted
}


func (e *CourseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCourseEntity(e.client, opts)
}

func (e *CourseEntity) Data(args ...any) any {
...
func (e *CourseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Course; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CourseEntity) DataTyped(data ...Course) Course {
	if len(data) > 0 {
		return typedFrom[Course](e.Data(asMap(data[0])))
	}
	return typedFrom[Course](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Course (all fields
// optional at the wire level).
func (e *CourseEntity) MatchTyped(match ...Course) Course {
	if len(match) > 0 {
		return typedFrom[Course](e.Match(asMap(match[0])))
	}
	return typedFrom[Course](e.Match())
}
...
func (e *CourseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CourseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CourseLoadMatch and returns an Course. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CourseEntity) LoadTyped(reqmatch CourseLoadMatch, ctrl map[string]any) (Course, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Course{}, err
	}
	return typedFrom[Course](res), nil
}




func (e *CourseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CourseListMatch and returns []Course. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CourseEntity) ListTyped(reqmatch CourseListMatch, ctrl map[string]any) ([]Course, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Course](res), nil
}




func (e *CourseEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CourseCreateData and returns an Course. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CourseEntity) CreateTyped(reqdata CourseCreateData, ctrl map[string]any) (Course, error) {
...
func (e *CourseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CourseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CourseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
