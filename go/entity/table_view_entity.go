...
func NewTableViewEntity(client *core.DreamapplySDK, entopts map[string]any) *TableViewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TableViewEntity) GetName() string { return e.name }
...
func (e *TableViewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TableViewEntity) Deleted() bool {
	return e.deleted
}


func (e *TableViewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTableViewEntity(e.client, opts)
}

func (e *TableViewEntity) Data(args ...any) any {
...
func (e *TableViewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TableView; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TableViewEntity) DataTyped(data ...TableView) TableView {
	if len(data) > 0 {
		return typedFrom[TableView](e.Data(asMap(data[0])))
	}
	return typedFrom[TableView](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TableView (all fields
// optional at the wire level).
func (e *TableViewEntity) MatchTyped(match ...TableView) TableView {
	if len(match) > 0 {
		return typedFrom[TableView](e.Match(asMap(match[0])))
	}
	return typedFrom[TableView](e.Match())
}
...
func (e *TableViewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TableViewEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TableViewLoadMatch and returns an TableView. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TableViewEntity) LoadTyped(reqmatch TableViewLoadMatch, ctrl map[string]any) (TableView, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return TableView{}, err
	}
	return typedFrom[TableView](res), nil
}




func (e *TableViewEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TableViewListMatch and returns []TableView. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TableViewEntity) ListTyped(reqmatch TableViewListMatch, ctrl map[string]any) ([]TableView, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TableView](res), nil
}



func (e *TableViewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TableViewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TableViewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TableViewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
