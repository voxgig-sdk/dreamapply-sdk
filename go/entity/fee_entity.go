...
func NewFeeEntity(client *core.DreamapplySDK, entopts map[string]any) *FeeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FeeEntity) GetName() string { return e.name }
...
func (e *FeeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FeeEntity) Deleted() bool {
	return e.deleted
}


func (e *FeeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFeeEntity(e.client, opts)
}

func (e *FeeEntity) Data(args ...any) any {
...
func (e *FeeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Fee; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FeeEntity) DataTyped(data ...Fee) Fee {
	if len(data) > 0 {
		return typedFrom[Fee](e.Data(asMap(data[0])))
	}
	return typedFrom[Fee](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Fee (all fields
// optional at the wire level).
func (e *FeeEntity) MatchTyped(match ...Fee) Fee {
	if len(match) > 0 {
		return typedFrom[Fee](e.Match(asMap(match[0])))
	}
	return typedFrom[Fee](e.Match())
}
...
func (e *FeeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FeeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FeeLoadMatch and returns an Fee. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FeeEntity) LoadTyped(reqmatch FeeLoadMatch, ctrl map[string]any) (Fee, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Fee{}, err
	}
	return typedFrom[Fee](res), nil
}




func (e *FeeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FeeListMatch and returns []Fee. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FeeEntity) ListTyped(reqmatch FeeListMatch, ctrl map[string]any) ([]Fee, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Fee](res), nil
}



func (e *FeeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FeeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FeeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FeeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
