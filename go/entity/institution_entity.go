...
func NewInstitutionEntity(client *core.DreamapplySDK, entopts map[string]any) *InstitutionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InstitutionEntity) GetName() string { return e.name }
...
func (e *InstitutionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InstitutionEntity) Deleted() bool {
	return e.deleted
}


func (e *InstitutionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInstitutionEntity(e.client, opts)
}

func (e *InstitutionEntity) Data(args ...any) any {
...
func (e *InstitutionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Institution; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InstitutionEntity) DataTyped(data ...Institution) Institution {
	if len(data) > 0 {
		return typedFrom[Institution](e.Data(asMap(data[0])))
	}
	return typedFrom[Institution](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Institution (all fields
// optional at the wire level).
func (e *InstitutionEntity) MatchTyped(match ...Institution) Institution {
	if len(match) > 0 {
		return typedFrom[Institution](e.Match(asMap(match[0])))
	}
	return typedFrom[Institution](e.Match())
}
...
func (e *InstitutionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InstitutionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InstitutionLoadMatch and returns an Institution. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InstitutionEntity) LoadTyped(reqmatch InstitutionLoadMatch, ctrl map[string]any) (Institution, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Institution{}, err
	}
	return typedFrom[Institution](res), nil
}




func (e *InstitutionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// InstitutionListMatch and returns []Institution. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *InstitutionEntity) ListTyped(reqmatch InstitutionListMatch, ctrl map[string]any) ([]Institution, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Institution](res), nil
}



func (e *InstitutionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InstitutionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InstitutionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InstitutionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
