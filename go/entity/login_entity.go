...
func NewLoginEntity(client *core.DreamapplySDK, entopts map[string]any) *LoginEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LoginEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LoginListMatch and returns []Login. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LoginEntity) ListTyped(reqmatch LoginListMatch, ctrl map[string]any) ([]Login, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Login](res), nil
}



func (e *LoginEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
