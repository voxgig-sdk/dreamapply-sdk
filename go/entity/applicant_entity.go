...
func NewApplicantEntity(client *core.DreamapplySDK, entopts map[string]any) *ApplicantEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ApplicantEntity) GetName() string { return e.name }
...
func (e *ApplicantEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApplicantEntity) Deleted() bool {
	return e.deleted
}


func (e *ApplicantEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewApplicantEntity(e.client, opts)
}

func (e *ApplicantEntity) Data(args ...any) any {
...
func (e *ApplicantEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Applicant; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ApplicantEntity) DataTyped(data ...Applicant) Applicant {
	if len(data) > 0 {
		return typedFrom[Applicant](e.Data(asMap(data[0])))
	}
	return typedFrom[Applicant](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Applicant (all fields
// optional at the wire level).
func (e *ApplicantEntity) MatchTyped(match ...Applicant) Applicant {
	if len(match) > 0 {
		return typedFrom[Applicant](e.Match(asMap(match[0])))
	}
	return typedFrom[Applicant](e.Match())
}
...
func (e *ApplicantEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ApplicantEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ApplicantLoadMatch and returns an Applicant. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ApplicantEntity) LoadTyped(reqmatch ApplicantLoadMatch, ctrl map[string]any) (Applicant, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Applicant{}, err
	}
	return typedFrom[Applicant](res), nil
}




func (e *ApplicantEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ApplicantListMatch and returns []Applicant. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ApplicantEntity) ListTyped(reqmatch ApplicantListMatch, ctrl map[string]any) ([]Applicant, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Applicant](res), nil
}




func (e *ApplicantEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ApplicantCreateData and returns an Applicant. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ApplicantEntity) CreateTyped(reqdata ApplicantCreateData, ctrl map[string]any) (Applicant, error) {
...
func (e *ApplicantEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ApplicantEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ApplicantEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
