...
const testSeed = `map[string]any{"entity": map[string]any{"academic_term": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "academic_year": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "administrator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "applicant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "application": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "course": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fee": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "institution": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "intake": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "invoice": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "journal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "login": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "scoresheet": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "table_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
